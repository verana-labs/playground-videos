// INTRO v2 (spec §3b) - the merged institutional intro, an independent
// video: foundations (W3C + eIDAS), the scalability gap, the question chain
// (reusing INTRO v1's scenes by kind, never touching v1's files), Verana's
// answer, the three freedoms, the essence close. INTRO v1 stays locked and
// byte-identical.
import { Shot, validateShots } from "./types";

export const INTRO2_SHOTS: Shot[] = validateShots([
  {
    id: "N-0",
    start: 0,
    end: 6,
  ...
  },
  {
    ...
    visual: { kind: "ecosystem-search-v2" },
    tone: "dark",
  },
  {
    id: "N-8",
  ...
  },
  {
    ...
    visual: { kind: "verana-close" },
    tone: "light",
  },
]);

export const INTRO2_END = 92;

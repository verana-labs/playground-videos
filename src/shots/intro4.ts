// INTRO v4 (spec/intro-v4.md) - v3 restyled to the verana.io Protocol Grid
// design system; independent copy, v3 stays locked. Scene kinds are the v4
// copies (IntroV4Scenes.tsx); audio is shared with v3 (same take + clips).
import { Shot, validateShots } from "./types";

export const INTRO4_SHOTS: Shot[] = validateShots([
  {
    id: "N-0",
    start: 0,
    end: 6,
  ...
  },
  {
    ...
    visual: { kind: "ecosystem-search-v4" },
    tone: "dark",
  },
  {
    id: "N-8b",
  ...
  },
  {
    ...
    visual: { kind: "verana-close-v4" },
    tone: "light",
  },
]);

export const INTRO4_END = 199;
